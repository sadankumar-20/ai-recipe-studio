...
/**
 * Refinement request: an edit instruction plus the recipe currently on
 * screen. The recipe is re-validated here rather than trusted, since the
...
export const refineRequestSchema = z.object({
  instruction: z
    .string()
    .trim()
    .min(3, "Describe the change you want (e.g. \"make it spicier\").")
    .max(300, "Keep the instruction under 300 characters."),
  currentRecipe: recipeSchema,
});
